...
def print_banner():
    ...
    print(f"{Fore.CYAN}║        Chat TTS Reader v1.1.0        ║{Style.RESET_ALL}")
    print(f"{Fore.CYAN}╚══════════════════════════════════════╝{Style.RESET_ALL}\n")


async def check_twitch_live(client_id: str, username: str) -> bool:
...
async def wait_for_twitch_or_bypass(client_id: str, username: str, check_interval: int = 30) -> bool:
    ...
    while True:
        ...
        # Check Twitch
        is_live = await check_twitch_live(client_id, username)
